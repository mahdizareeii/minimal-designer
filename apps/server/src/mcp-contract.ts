...
export const MCP_TOOL_CONTRACTS = {
  ...
  design_preview_changes: tool(
    "preview",
    scopes("design:preview", "design:read"),
    allHumanRoles,
    "required",
    "EnterpriseService.authorizeAgentTaskDesignPreviewWork",
    "DesignerService.createPreview",
    "DesignerService.requireDesign",
  ),
  design_preview_archive_nodes: tool(
    "preview",
    scopes("design:preview", "design:read"),
    allHumanRoles,
    "required",
  ...
  design_commit_preview: tool("write", denied, [], "required", "website human approval only"),
  design_commit_archive_preview: tool("destructive", denied, [], "required", "website human approval only"),
  design_history: tool("read", scopes("design:read"), allHumanRoles, "required", "DesignerService.history"),
  design_restore_revision: tool("write", denied, [], "required", "website human action only"),
