---
name: formaspec
description: Create, inspect, refine, and redesign structured FormaSpec projects through the formaspec MCP server. Use for exact triggers such as “Use FormaSpec”, “Design this with FormaSpec”, “Refine this selection with FormaSpec”, and “Redesign this with FormaSpec”, or for legacy compatibility triggers such as “Use Minimal UI” and “Improve this selection with Minimal UI”, whenever a user asks an agent to produce or revise an editable web, phone, or tablet interface in FormaSpec.
---
