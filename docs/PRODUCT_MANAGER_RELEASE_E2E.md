...
5. Enter the canonical product brief and create a website-owned Codex task.
...
13. Commit the exact preview atomically as an immutable revision.
14. Complete the website task with its expected preview output.
