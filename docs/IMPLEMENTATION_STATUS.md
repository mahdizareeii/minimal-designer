...
matrix also passes. Native installers, SBOM/license refresh, hosted provenance,
real server-mode/off-site recovery, and supported-OS lifecycle evidence remain
unverified.
...
| Schema-13 application and source gates | Source declares database schema 13, command engine 2, renderer 3, renderer IPC protocol 2, and font bundle 1. Migration 13 persists canonical component source JSON/SHA-256 plus immutable exact base/result snapshot metadata for design-system upgrade previews. Current source exposes 52 MCP tools, 25 resources, and 108 protected non-MCP routes. Application suites pass 678/678; launcher passes 212/212; all seven workspaces pass typecheck and production build. Focused component-library/insertion server 16/16, browser 6/6, CLI command 23/23, MCP contract 5/5, route contract/coverage 12/12, and component source/materialization/release-resolution cases are included in that current evidence. |
...
| Historical migration fixtures | The prior deterministic schema 1 and schema 7–11 fixtures passed through schema 12 without fabricating handoff execution decisions. Focused schema-13 migration tests additionally upgrade a genuine schema-12 fixture without inventing component sources or exact upgrade-preview metadata; legacy null-source versions stay readable. Broader verified-backup restore coverage at schema 13 is pending. |
...
| Enterprise editor and administration browser coverage | Current schema-13 Playwright Chromium passed 4/4: Pages/Layers/Components/Assets, Canvas/Prototype/Before-After, the six-section inspector, keyboard/focus and activity/diagnostic/revision/handoff contract; click-to-frame navigation without canonical mutation; the guided policy form; and exact manual component insertion. The insertion case backs up and migrates V1→V2, loads the pinned Foundation catalog, renders an isolated preview without head mutation, commits through ordinary CAS, reloads version 3, and verifies the active projected instance. The dedicated handoff browser flow also passed 1/1. |
| Browser selection alignment and revision inspect | Current schema-13 Chrome selection alignment passed 12/12 across DPR 1/2; 12/25/50/100/149/150/200/320% zoom; fractional pan; LTR/RTL/mixed text; image, frame, ellipse, rotated single/multi-selection, hidden/locked exclusion, nested scroll/font/image invalidation, group drag, auto-layout reorder/reparent, and fill-to-fixed resize, all within 0.75 CSS px. Revision-inspect immutability passed 1/1 after the head-update fixture was corrected to edit the active root frame rather than an immutable detached component master. |
| Visual regression foundation | Current schema-13 Playwright Chrome DPR 1 passed 7/7 approved native-size prototype baselines: desktop, phone, tablet, Persian RTL, typography, clipping, and normalized uploaded image. |
...
| 1,000-node browser budgets | Current schema-13 pinned Chromium passed 1/1: 230.70 ms p95 cold interactive load, 20.50 ms selection, 16.70 ms gesture p95/maximum, 273.20 ms commit/autosave, 17.60 ms history, 280.48 ms preview validation excluding render, and 221.37 ms for a 1440×900 PNG. |
| Integrated PM-to-restore E2E | Current schema-13 Playwright passed the complete 20-step PM→MCP→human correction→history→export→backup/restore/restart scenario 1/1. |
| Current schema-13 Compose/runtime | Disposable project `formaspeccischema13da9af9d064` used image `sha256:166d74686a8ebd52c2765d0c12b362690717af8488a7a4b83f0f1e348d620b97`, reached schema-13 readiness, created design `document_e171c68c7a4c4b3b80a5493a6180e28f` at revision `revision_85e2776ca3874f1c98097b6917bc3649`, and rendered a 512×339 PNG with SHA-256 `cacf72adda9b70d6c7e732676da6c2be2575d7b456abffb35d04f749cfe7bdcf` before and after API restart. Renderer egress failed closed with DNS `EAI_AGAIN`, TCP `ENETUNREACH`, and zero external interfaces; cleanup passed. Summary: `/private/tmp/formaspec-docker-schema13-20260721-current/summary.json`, SHA-256 `13c608ce5ddec282d8e0b8497d54f9971f4f20764d035122ea5e64dfd31f1e0f`. |
...
| Current runtime/workflow evidence | The schema-13 image passed Firefox/WebKit alignment 12/12 with complete cleanup; summary `/private/tmp/formaspec-cross-browser-schema13-20260721-current/summary.json`, SHA-256 `c128ee3f6a7341cd75189dba612d6b01d25abd2b57fb26db1970c152f1f665bc`. The same image passed same-machine copied-bundle recovery from `formaspecdrsource3af2259e48` to `formaspecdrtarget3af2259e48`, preserving design/revision/snapshot/asset/render/SQLite/FK integrity with complete cleanup; bundle SHA-256 `b87d44e7b0584dd0a14e5b47d07cf447490a683ab512f983feb4e2a19c0a6ef3`, summary SHA-256 `1dfecf9b4a4773fed25f73eaa181bc88e30fc21df8b0679c3325241af3ccd433`. Current macOS-runtime/workflow/cross-browser/off-host contract sets pass 10/10, 8/8, 2/2, and 7/7. No native schema-13 package, SBOM/license refresh, hosted run, signature, scan, or provenance has been retained. |
...
| Release CI and evidence | **Partial** | Current schema-13 application suites pass 678/678, launcher 212/212, all seven typechecks/builds, the full 52-tool/25-resource/108-route contract/authorization matrix, Chrome editor/selection/handoff/visual/inspect/performance/20-step gates, randomized Docker restart/egress, Firefox/WebKit 12/12, and copied-bundle recovery. No schema-13 native installer, current SBOM/license report, signed provenance, scans, hosted run, supported-OS lifecycle matrix, or real server-mode/off-site recovery has been retained. | Complete the remaining security/native-delivery/operations matrix, then keep release closed on Chromium/license-policy approval, signing/notarization, reproducibility, artifact/image/OS scanning, clean native lifecycle proof, real server-mode/off-site recovery, provenance, and retained hosted evidence. |
...
- Complete the remaining schema-13 release cycle: broader security and
  backup/restore fixtures, SBOM/license and
  vulnerability scans, native installers, and retained hosted evidence. The
  application, launcher, all-workspace build/typecheck, Chrome/Firefox/WebKit,
  performance, 20-step E2E, Docker restart/egress, and copied-bundle gates now
  pass locally.
...
- Artifact-specific container, Windows, and Linux SBOMs; image/OS scans;
  ...
  workspace outputs; current schema-13 source has not received a refreshed
  license/SBOM or package gate. Its same-host outer bytes are nondeterministic,
